...
function displayPics() {
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT  // case const is a block-scope and we decler it inside the function in this case the console will not see it in global scope
  console.log(viewed);
